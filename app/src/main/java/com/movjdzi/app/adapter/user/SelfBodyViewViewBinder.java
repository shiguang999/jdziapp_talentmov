...
import com.movjdzi.app.view.AllDownLoadActivity;
import com.movjdzi.app.view.AllFavorActivity;
import com.movjdzi.app.view.AllHistoryActivity;
import com.movjdzi.app.view.CastDescriptionnActivity;
import com.movjdzi.app.view.LoginActivity;
import com.movjdzi.app.view.ReportActivitys;
import com.movjdzi.app.view.WebDetailActivity;
...
public class SelfBodyViewViewBinder extends ItemViewBinder<SelfBodyView, SelfBodyViewViewBinder.ViewHolder> {
    ...
    protected void onBindViewHolder(@NonNull ViewHolder holder, @NonNull SelfBodyView selfBodyView) {
        ...
        holder.selfQQ.setOnClickListener(v -> new XPopup.Builder(v.getContext()).asConfirm("提示", "欢迎加入qq群：" + App_Config.QQ_QUN, () -> {
        }).show());
